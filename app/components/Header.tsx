    ...
    <header className="sticky top-0 z-20 border-b border-white/10 bg-white/95">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between gap-8">
        ...
        <a href="#home" className="flex items-center gap-3 no-underline shrink-0">
          <img src="/images/logo.png" alt="UPV RRC" className="h-12 w-auto object-contain" />
        </a>
      ...
      {mobileOpen && (
        <div className="md:hidden border-t border-cream bg-white">
          ...
          >
            Services
            <svg width="10" height="10" viewBox="0 0 10 10" fill="none" className={`transition-transform ${mobileServicesOpen ? "rotate-180" : ""}`}>
